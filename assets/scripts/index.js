...
function bindGeneralButtons() {
    ...
    homeBtn.addEventListener("click", resetCards); //Added to reset cards on click
...
/**
 * Function to reset cards on home page press, goes through each card and resets it to 
 * default values
 * @authors Kevin Wong
 * @date 5/29/2023
 */
